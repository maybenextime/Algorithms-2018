...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(3 to 6, optimizeBuyAndSell("input/buysell_in4.txt"))
        try {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("123", longestCommonSubstring("5126123", "0179643123"))
        assertEquals("A", longestCommonSubstring("ACCount", "maccCA"))
...
Еще старушка не забыла
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(6, calcPrimesNumber(14))
    ...
    fun baldaSearcher(baldaSearcher: (String, Set<String>) -> Set<String>) {
        ...
        assertEquals(setOf("ЗРЦУКРГПГ", "фЫВАПРР"),
                baldaSearcher("input/balda_in2.txt", setOf("ЗРЦУКРГПГ", "фЫВАПРР", "AAAAAAAA")))
